...
import com.jeferro.products.accounts.domain.repositories.AccountRepositoryInMemory
...
class SignInHandlerTest {
    ...
    private val accountRepositoryInMemory = AccountRepositoryInMemory()
    ...
    fun `should sign in user`() = runTest {
        ...
        accountRepositoryInMemory.reset(account)
    ...
    fun `should fail when user doesn't exist`() = runTest {
        accountRepositoryInMemory.clear()
